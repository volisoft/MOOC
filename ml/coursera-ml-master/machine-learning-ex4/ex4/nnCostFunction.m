...
%recode labels into boolean vecrors
...
%regularized cost
Theta1(:, 1) = 0; % omit bias
Theta2(:, 1) = 0; % omit bias
all_thetas_vector = [Theta1(:) ; Theta2(:)];
J = 1/m * sum(J(:)) + lambda/(2*m) * sum(all_thetas_vector.^2);
% -------------------------------------------------------------
